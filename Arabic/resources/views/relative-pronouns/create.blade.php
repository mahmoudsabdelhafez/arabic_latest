...
<div class="container">
    <div class="content-card">
        <div class="card-header">
            <h2 class="card-title">إضافة اسم موصول جديد</h2>
        ...
        <form action="{{ route('relative-pronouns.store') }}" method="POST">
            @csrf
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <select id="number" name="number" required
                    ...
                    <option value="مفرد" {{ old('number') == 'مفرد' ? 'selected' : '' }}>مفرد</option>
                    <option value="مثنى" {{ old('number') == 'مثنى' ? 'selected' : '' }}>مثنى</option>
                    <option value="جمع" {{ old('number') == 'جمع' ? 'selected' : '' }}>جمع</option>
                </select>
            </div>
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <select id="gender" name="gender" required
                    ...
                    <option value="مذكر" {{ old('gender') == 'مذكر' ? 'selected' : '' }}>مذكر</option>
                    <option value="مؤنث" {{ old('gender') == 'مؤنث' ? 'selected' : '' }}>مؤنث</option>
                    <option value="مشترك" {{ old('gender') == 'مشترك' ? 'selected' : '' }}>مشترك</option>
                </select>
            </div>
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <textarea id="example" name="example" rows="3" required
                    style="width: 100%; padding: 0.75rem; border: 1px solid rgba(0, 0, 0, 0.1); border-radius: 8px;">{{ old('example') }}</textarea>
            </div>
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <textarea id="grammatical_analysis" name="grammatical_analysis" rows="5" required
                    style="width: 100%; padding: 0.75rem; border: 1px solid rgba(0, 0, 0, 0.1); border-radius: 8px;">{{ old('grammatical_analysis') }}</textarea>
            </div>
