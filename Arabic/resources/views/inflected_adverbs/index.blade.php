                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2 justify-content-center">
                                    ...
                                    <!-- Delete Button -->
                                    <form action="{{ route('inflected_adverbs.destroy', $record->id) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('inflected_adverbs.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label">النوع</label>
                            <select name="adverb_type" class="form-control" required>
                                <option value="مبهمة">مبهمة</option>
                                <option value="مختصة">مختصة</option>
                            </select>
                        </div>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            document.querySelectorAll(".edit-btn").forEach(button => {
                button.addEventListener("click", function () {
                    ...
                    document.getElementById("editRecordForm").action = `/inflected_adverbs/${this.dataset.id}`;
                });
            });
        });
    </script>
