    ...
    <div class="body">
        ...
        <div class="main-container">
            <aside class="sidebar">
                ...
                <div class="nav-item" onclick="showSection('augmented')"><span class="nav-icon">📝</span> الأوزان
                    الصرفية
                </div>
    ...
    function toggleDropdown() {
        ...
        menu.style.display = menu.style.display === "none" || menu.style.display === "" ? "block" : "none";
            ...
            <main class="main-content">
                ...
                <section id="built_verbs" class="section">
                    <h2>المبنيات </h2>
                    <div class="button-container">
                        <a href="{{ url('/built_verbs') }}" class="button">الافعال المبينة</a>
                    </div>
                </section>
                <section id="analyzing_weakening" class="section">
                    <h2>تحليل الضعف</h2>
                    <div class="button-container">
                        <a href="{{ url('/analyzing_weakening') }}" class="button">تحليل الضعف</a>
                    </div>
                </section>
                <section id="demonstrative_pronouns" class="section">
                    <h2>الإشارة </h2>
                    <div class="button-container">
                        <a href="{{ url('/demonstrative_pronouns') }}" class="button">الإشارات</a>
                    </div>
                </section>
                <section id="derived_words" class="section">
                    <h2>الكلمات المشتقة </h2>
                    <div class="button-container">
