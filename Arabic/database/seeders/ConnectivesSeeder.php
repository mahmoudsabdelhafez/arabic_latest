...
class ConnectivesSeeder extends Seeder
{
    public function run()
    {
        $data = [
            'Conjunctions' => [
                ['arabic_form' => 'و', 'transliteration' => 'and', 'pronunciation' => '(wa)', 'meaning' => 'جاء محمد و علي (Ja\'a Muhammad wa Ali) - Muhammad and Ali came', 'grammatical_function' => null,  'is_classical' => false, 'notes' => null, 'status' => 'draft'],
                ['arabic_form' => 'ف', 'transliteration' => 'then, so, therefore', 'pronunciation' => '(fa)', 'meaning' => 'دخل فجلس (Dakhala fa-jalasa) - He entered, then sat down', 'grammatical_function' => null,  'is_classical' => false, 'notes' => null, 'status' => 'draft'],
            ...
            'ParticlesOfResult' => [
                ['arabic_form' => 'ف', 'transliteration' => 'fa-', 'pronunciation' => '(fa-)', 'meaning' => 'درستُ فنجحتُ (Darastu fa-najahtu) - I studied, so I succeeded', 'grammatical_function' => null,  'is_classical' => false, 'notes' => null, 'status' => 'draft'],
        ...
        foreach ($categoryNames as $categoryName) {
            ...
            foreach ($data[$categoryName] as $connective) {
                DB::table('connectives')->insert([
                    ...
                    'created_at' => Carbon::now(),
                    'updated_at' => Carbon::now(),
                    'created_by' => null, // Optional: Set as per your application logic
                    'updated_by' => null, // Optional: Set as per your application logic
                ]);
            }
}
}
